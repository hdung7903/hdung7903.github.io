...
import '../Test.css';
import { Part } from '../../../../types/data.interfaces';

const MathModule: React.FC<{ part: Part }> = ({ part }) => {
    ...
    const directions = [
        ...
        'If your answer is a mixed number (such as 3½), enter it as an improper fraction (⁷/₂) or its decimal equivalent (3.5).',
            ...
            <Container className="flex-grow-1">
                <Row className="py-4">
                    <Col md={6} className="border-end">
                        <h4 style={{ fontWeight: "bold" }}>Student-produced response directions</h4>
